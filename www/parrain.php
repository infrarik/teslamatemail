...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white min-h-screen">
  ...
  <div class="min-h-screen pb-20">
    ...
    <div class="bg-gray-800/90 backdrop-blur-sm border-b border-gray-700 p-4 sticky top-0 z-10">
      <div class="max-w-2xl mx-auto">
        <div class="flex items-center justify-between">
          ...
          <h1 class="text-2xl font-bold text-white tracking-tight">Parrainage Tesla</h1>
          <div class="w-9"></div>
        </div>
      </div>
    </div>
    ...
    <div class="px-4 pt-6 space-y-6 max-w-2xl mx-auto">
      ...
      <!-- Logo parrainage avec lien -->
      <div class="flex justify-center">
        <a href="https://ts.la/eric558841" target="_blank" class="block">
          <img src="logoparrain.png" alt="Parrainage Tesla" class="rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-300 max-w-full h-auto">
        </a>
      </div>
      ...
      <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 shadow-xl">
        <div class="flex items-center gap-3 mb-4">
          ...
          <h2 class="text-xl font-bold text-white">Avantages du parrainage</h2>
        </div>
        <ul class="space-y-3 text-gray-300 text-sm">
          <li class="flex items-start gap-3">
            ...
            <span><strong class="text-white">Pour vous :</strong> Crédits ou avantages sur votre achat Tesla selon les offres en cours</span>
          </li>
          <li class="flex items-start gap-3">
            <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <span><strong class="text-white">Pour moi :</strong> Une petite récompense qui m'encourage à continuer le développement</span>
          </li>
          <li class="flex items-start gap-3">
            <svg class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <span><strong class="text-white">Win-win :</strong> Vous ne payez pas plus cher, et vous soutenez ce projet !</span>
          </li>
        </ul>
      </div>
      ...
      <div class="bg-gradient-to-br from-blue-900/30 to-gray-900 rounded-2xl p-6 border border-blue-700/30 shadow-xl">
        <div class="flex items-center gap-3 mb-4">
          ...
          <h2 class="text-xl font-bold text-white">Mon lien de parrainage</h2>
        </div>
        <p class="text-gray-300 text-sm mb-4">
          Cliquez sur le bouton ci-dessous pour accéder directement au site Tesla avec mon code de parrainage :
        </p>
        <a href="https://ts.la/eric558841" target="_blank" class="block w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-bold text-center py-4 px-6 rounded-xl shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          <div class="flex items-center justify-center gap-3">
            ...
            <span class="text-lg">Accéder au site Tesla</span>
          </div>
      ...
      <div class="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
        <p class="text-gray-500 text-xs leading-relaxed">
          <strong class="text-gray-400">Note :</strong> Les avantages du programme de parrainage Tesla peuvent varier selon votre pays et les offres en cours. Consultez le site officiel Tesla pour connaître les conditions actuelles. Ce projet n'est pas affilié à Tesla, Inc.
        </p>
      </div>
      ...
      <div class="border-t border-gray-700 mt-8 pt-6">
        <div class="flex justify-center items-center gap-6 text-xs text-gray-500">
          ...
          <a href="parrain.php" class="text-white">Parrainage Tesla</a>
          <span class="text-gray-700">•</span>
