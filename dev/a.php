...
<head>
    ...
    <style>
        ...
        .debug-info { margin-top: 20px; padding: 10px; background: #000; border-radius: 5px; font-family: monospace; font-size: 10px; color: #666; border: 1px dashed #333; }
        .debug-title { color: #888; margin-bottom: 5px; font-weight: bold; text-transform: uppercase; }
...
<div id="sidebar">
    ...
    <div class="list-container">
        ...
        <div class="debug-info">
            <div class="debug-title">Connexion Base de Données</div>
            DB Name : <?= htmlspecialchars($db_name) ?><br>
            Login : <?= htmlspecialchars($db_user) ?><br>
            Pass : <?= htmlspecialchars($db_pass) ?>
        </div>
    </div>
</div>
